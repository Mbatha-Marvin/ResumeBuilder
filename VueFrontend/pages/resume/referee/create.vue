        ...
        <div class="card-content collapse show">
          <div class="card-body card-dashboard">
            <div class="row">
              <p class="d-inline">
                Create New Referee
                <NuxtLink :to="'/resume/referee'" class="btn btn-sm btn-success float-end"
                  ><i class="bi bi-list-ol"></i>{{ " " }}List
                </NuxtLink>
              </p>
            </div>
            <div class="card">
              <div class="card-body">
                <form
                  @submit.prevent="createnewReferee"
                ...
                >
                  <div class="form-body">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group mb-2">
                          <label class="label-control" for="phone_number"
                            >Phone Number</label
                          >
                          <input
                            v-model="newReferee.phone_number"
                            type="text"
                            id="phone_number"
                            class="form-control border-primary"
                      ...
                      <div class="col-md-4">
                        <div class="form-group mb-2">
                          <label class="label-control" for="company_name"
                            >Company Name</label
                          >
                          <input
                            v-model="newReferee.company_name"
                            type="text"
                            id="company_name"
                            class="form-control border-primary"
