            ...
            <div class="col-md-12">
                <div class="card mb-2">
                    <div class="card-body rounded">
                        <h4 class="text-center text-uppercase bold">Education Section</h4>
                    </div>
                </div>
                <div class="card mb-2">
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <div class="row">
                                <h4 class="d-inline">Education List
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row mb-2">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input v-model="education.location" type="text"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row mb-2">
                                                            <label class="col-md-3 label-control" for="end_date">End
                                                                date</label>
                                                            <div class="col-md-9">
                                                                <input v-model="education.end_date" type="date"
