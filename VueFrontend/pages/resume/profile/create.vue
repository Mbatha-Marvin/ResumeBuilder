                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row mb-2">
                                                            <label class="col-md-3 label-control" for="first_name">First
                                                                Name</label>
                                                            <div class="col-md-9">
                                                                <input v-model="newProfile.first_name" type="text"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row mb-2">
                                                            <label class="col-md-3 label-control" for="last_name">Last
                                                                Name</label>
                                                            <div class="col-md-9">
                                                                <input v-model="newProfile.last_name" type="text"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row mb-2">
                                                            <label class="col-md-3 label-control" for="middle_name">Middle
                                                                Name</label>
                                                            <div class="col-md-9">
                                                                <input v-model="newProfile.middle_name" type="text"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row mb-2">
                                                            <label class="col-md-3 label-control" for="image_url">Image url
                                                                link</label>
                                                            <div class="col-md-9">
                                                                <input v-model="newProfile.image_url" type="text"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row mb-2">
                                                            <label class="col-md-3 label-control" for="github_url">Github
                                                                url link</label>
                                                            <div class="col-md-9">
                                                                <input v-model="newProfile.github_url" type="text"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row mb-2">
                                                            <label class="col-md-3 label-control" for="objectives">Job
                                                                Objective</label>
                                                            <div class="col-md-9">
                                                                <input v-model="newProfile.objectives" type="text"
