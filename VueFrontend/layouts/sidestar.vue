...
<<<<<<< HEAD
  <div class="d-flex" id="wrapper">
    <!-- Sidebar-->
    <div class="border-end bg-white" id="sidebar-wrapper" :class="{ 'sb-sidenav-toggled': sidebarOpen }">
...
//     {
//       rel: "stylesheet",
//       href: "/assets/sidebar/css/styles.css"
//     }
//   ],
//   script: [
//     {
//       type: "text/javascript",
//       src: "/assets/sidebar/js/scripts.js"
//     }
//   ]
// });
